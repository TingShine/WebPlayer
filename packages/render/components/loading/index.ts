...
const LOADING_ICON = `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#fff" height="48px" width="48px" version="1.1" id="Layer_1" viewBox="0 0 330 330" xml:space="preserve">
<g id="XMLID_2_">
...
export class LoadingIcon extends Component {
	...
	private initDOM() {
		...
		div.style.height = "48x"
		div.innerHTML = LOADING_ICON
		div.className = "player-loading-icon"
